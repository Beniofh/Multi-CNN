...
# is for 1.1 
dossier_save_1_1 = 'auto_save(amar+mono, 128, on, full)'                                                                
checkpoint_1_1 = '0390'                                                 
# is for 2.1 
...
# is for 3A.1    
dossier_save_aa = "auto_save(aa+other_amar, 128, on, full)"                                                                 
checkpoint_aa = "0488" 
# is for 3A.2 
dossier_save_aj ="auto_save(aj+other_amar, 128, on, full)"                                                                 
checkpoint_aj = "0452"     
# is for 3A.3 
dossier_save_al ="auto_save(al+other_amar, 128, on, full)"                     
checkpoint_al = "0476"     
# is for 3B.1  
dossier_save_c ="auto_save(c+other_mono, 128, off, off)"                    
checkpoint_c  = "0044" 
# is for 3A.4 
dossier_save_ca ="auto_save(ca+other_amar, 128, on, full)"                     
checkpoint_ca = "0216"     
# is for 3A.5
dossier_save_co ="auto_save(co+other_amar, 128, on, full)"                    
checkpoint_co = "0380"      
# is for 3A.6 
dossier_save_dm ="auto_save(dm+other_amar, 128, on, full)"                     
checkpoint_dm = "0429"     
# is for 3B.2 
